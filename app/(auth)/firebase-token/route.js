// app/(auth)/firebase-token/route.js
...
// Initialize Firebase Admin using a function to ensure singleton pattern
...
export async function POST(request) {
  try {
    ...
    // Initialize Firebase Admin if needed and create a custom token
    const adminInstance = getOrInitializeFirebaseAdmin();
    const firebaseToken = await adminInstance.auth().createCustomToken(userId);
